...
### Data Collection
The data was collected using the folowing procedure: 
...
6. In the `analysis.py` file, get all dictionaries from the other files and them into a mega-dictionary, consisting of all 3 model types for all 4 labels, for both weighted and unweighted groups. 
7. Calculate result metrics and sort important data from the mega-dictioanry into a pandas dataframe for easy manipulation. 
...
|Model_key               |Label    |F1    |Balanced_accuracy|
|------------------------|---------|------|-----------------|
